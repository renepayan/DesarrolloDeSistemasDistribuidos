public class MultiplicaMatrices{
    ...
    static int[][] separa_matriz(int[][] A, int renglon_inicial){
        int[][] M = new int[N/2][N];
        for(int i = 0; i < N/2; i++){
            for(int j = 0; j < N; j++){
...
int[][] A1 = separa_matriz(A, 0);
int[][] A2 = separa_matriz(A, N/2);
int[][] B1 = separa_matriz(A, 0);
int[][] B2 = separa_matriz(A, N/2);

int[][] C1 = multiplica_matrices(A1, B1);
int[][] C2 = multiplica_matrices(A2, B2);
int[][] C3 = multiplica_matrices(A1, B1);
int[][] C4 = multiplica_matrices(A2, B2);
